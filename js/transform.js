...
var transformObj = {
    ...
    setObj: function (obj, destPoints, objWidth, objHeight) {
        ...
        var transformData = 'matrix3d(' + function () {
            "use strict";
            var i, k, H, results;
            results = [];
...
var canvasTransformObj = {
    ...
    divide: function (u1, v1, u4, v4, p1, p2, p3, p4, limit) {
        "use strict";
        var transform = this.getProjectiveTransform(this._points);
        ...
        var iw = this._srcImage.width;
        var ih = this._srcImage.height;
